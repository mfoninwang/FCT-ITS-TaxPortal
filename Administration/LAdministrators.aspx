<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LAdministrators.aspx.cs" Inherits="TAAPs.Administration.LAdministrators" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="dsUsers" Width="100%" KeyFieldName="UserName" OnRowUpdating="ASPxGridView1_RowUpdating" OnCellEditorInitialize="ASPxGridView1_CellEditorInitialize" OnCustomErrorText="ASPxGridView1_CustomErrorText" OnRowInserting="ASPxGridView1_RowInserting" ClientInstanceName="grid">
        ...
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn Caption="Tax Office" FieldName="TaxOfficeId" VisibleIndex="8">
        ...
        <Templates>
            <EditForm>
                ...
                <dx:ASPxFormLayout ID="formLayout" runat="server" Width="100%" EnableTheming="True">
                    ...
                    <Items>
                        <dx:LayoutGroup ColCount="2" Width="100%" Caption="Basic Info">
                            <Items>
                                <dx:LayoutItem FieldName="UserName" RequiredMarkDisplayMode="Required">
                                ...
                                <dx:LayoutItem Caption="Role" FieldName="RoleId" RequiredMarkDisplayMode="Required">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="ASPxFormLayout1_E2" runat="server" DataSourceID="dsRoles" TextField="RoleName" ValidationSettings-ValidationGroup="<%#     (Container.NamingContainer as GridViewEditFormTemplateContainer).ValidationGroup     %>" Value='<%# Eval("RoleId") %>' ValueField="RoleId" ValueType="System.Int32" Width="100%">
                                ...
                                <dx:LayoutItem Caption="Tax Office" ColSpan="2" Width="100%">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                            <dx:ASPxGridViewTemplateReplacement ID="ASPxGridViewTemplateReplacement2" runat="server" ColumnID="TaxOfficeId" ReplacementType="EditFormCellEditor" />
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                            </Items>
                ...
                <div style="text-align: right; padding: 10px 10px 10px 10px">
                    ...
                    <dx:ASPxButton ID="ASPxButtonPwdReset" runat="server" Text="Reset Password" OnClick="ASPxButtonPwdReset_Click" RenderMode="Link" OnInit="ASPxButtonPwdReset_Init"></dx:ASPxButton>
    ...
    <asp:EntityDataSource ID="edsTaxOffices" runat="server" ConnectionString="name=TAAPsDBContext" DefaultContainerName="TAAPsDBContext" EnableFlattening="False" EntitySetName="TaxOffices" Select="it.[TaxOfficeId], it.[TaxOfficeName], it.[RegionId]" Where="it.RegionId = @RegionId" EntityTypeFilter="">
        <WhereParameters>
            <asp:SessionParameter Name="RegionId" SessionField="UserRegionId" Type="String" />
        </WhereParameters>
    </asp:EntityDataSource>
