<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="IAssessment.aspx.cs" Inherits="TAAPs.Assessment.IAssessment" %>
...
"
    ...
    <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" AllowDragging="True" Modal="True" Width="600px" CloseOnEscape="True" HeaderText="Tax Remittance Breakdown" MinHeight="400px" PopupElementID="ASPxButtonTaxDetails" EnableViewState="False" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Target="_blank" ClientInstanceName="popup" MinWidth="600px" OnWindowCallback="ASPxPopupControl1_WindowCallback">
